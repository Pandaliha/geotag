...
var gtaLocator = (function GtaLocator() {
    ...
    var onsuccess = function (position) {
        ...
        //Abgerufene Latitude-Standort-Daten in Formular einfügen
        var lat = document.getElementById("latitude");
        lat.value = latitude;

        //Abgerufene Longitude-Standort-Daten in Formular einfügen
    ...
    return { // Start öffentlicher Teil des Moduls ...
        ...
        updateLocation: function () {								//funktion in einem Objekt, deshalb andere Deklaration - Logik aber gleich
            var lat = document.getElementById("latitude");
